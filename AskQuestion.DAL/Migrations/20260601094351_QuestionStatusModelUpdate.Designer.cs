...
namespace AskQuestion.DAL.Migrations
{
    ...
    [Migration("20260601094351_QuestionStatusModelUpdate")]
    partial class QuestionStatusModelUpdate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AskQuestion.DAL.Entities.QuestionStatusTransition", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("QuestionStatusTransitions");
                });

            modelBuilder.Entity("AskQuestion.DAL.Entities.QuestionVote", b =>
                {
                    b.Property<Guid>("QuestionId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("AskQuestion.DAL.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTimeOffset(new DateTime(2023, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Login = "Admin",
                            Password = "$2a$11$q385hN2923xQ0sWnC9I84eaC4jNqSx8m9HzZgZYUxBjh9vBX8cr1S",
                            UserRoleId = 1
                        });
                });
            ...
            modelBuilder.Entity("AskQuestion.DAL.Entities.Question", b =>
                {
                    b.HasOne("AskQuestion.DAL.Entities.Area", "AreaEntity")
                        .WithMany()
                        .HasForeignKey("AreaId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("AskQuestion.DAL.Entities.User", "SpeakerUser")
                        .WithMany()
                    ...
                    b.Navigation("SpeakerUser");
                });

            modelBuilder.Entity("AskQuestion.DAL.Entities.QuestionStatusTransition", b =>
                {
                    b.HasOne("AskQuestion.DAL.Entities.User", "ChangedByUser")
                        .WithMany()
                        .HasForeignKey("ChangedByUserId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("AskQuestion.DAL.Entities.Question", "Question")
                        .WithMany()
