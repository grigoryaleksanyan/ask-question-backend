...
namespace AskQuestion.DAL.Migrations
{
    ...
    [Migration("20260529162702_AddQuestionVotes")]
            ...
            modelBuilder.Entity("AskQuestion.DAL.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("262c937a-fe40-45de-88a9-4fafee4aae1e"),
                            Created = new DateTimeOffset(new DateTime(2026, 5, 29, 16, 27, 2, 649, DateTimeKind.Unspecified).AddTicks(4141), new TimeSpan(0, 0, 0, 0, 0)),
                            Login = "Admin",
                            Password = "$2a$11$xU290PNC5AhsmkUzR.3BpeKREsMJSm6uqsurKQFYl5zKU3DKqznc2",
                            UserRoleId = 1
                        });
                });
