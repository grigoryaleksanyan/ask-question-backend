...
namespace AskQuestion.DAL.Migrations
{
    ...
    [Migration("20260528121407_FixCyrillicCreatedProperty")]
    partial class FixCyrillicCreatedProperty
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AskQuestion.DAL.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("0bedc959-e585-46df-b197-8a6f499ffabc"),
                            Created = new DateTimeOffset(new DateTime(2026, 5, 28, 12, 14, 6, 15, DateTimeKind.Unspecified).AddTicks(2617), new TimeSpan(0, 0, 0, 0, 0)),
                            Login = "Admin",
                            Password = "$2a$11$iiSAbIFe.mANGjFOxuXf.evse1E6YK0z3IWw78Q8oS6w3dEJ2FZfq",
                            UserRoleId = 1
                        });
                });
